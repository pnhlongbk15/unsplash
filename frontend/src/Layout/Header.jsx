        ...
        {user && (
          <>
            ...
            <div className='relative group'>
              <img src={user?.photoURL} alt='user' className='w-6 h-6 rounded-full cursor-pointer' />
              <div className='hidden z-50 bg-white absolute bottom-2 right-0 translate-y-[110%] border-gray-300 border group-hover:flex flex-col rounded-sm  shadow-lg'>
                ...
                <div className='whitespace-nowrap text-sm text-gray-500'>
                  <div className=' border-b-[1.5px] py-1'>
                    ...
                    <p className=' p-2 cursor-pointer hover:bg-gray-200'>View profile</p>
                  ...
                  <div className='py-1'>
                    <p className='p-2 cursor-pointer hover:bg-gray-200'>Logout user</p>
                  </div>
                </div>
